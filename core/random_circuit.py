...
def generate_with_pool(num_qubits: int, depth: int, pool=constant.operations, max_operands: int=3,
...
#                 q for q in remaining_qubits if q not in operands]
#             if num_operands == 1:
#                 operation = rng.choice(constant.one_q_ops)
#             elif num_operands == 2:
#                 operation = rng.choice(constant.two_q_ops)
#             elif num_operands == 3:
#                 operation = rng.choice(constant.three_q_ops)
#             if operation in constant.one_param:
#                 num_angles = 1
#             elif operation in constant.two_param:
#                 num_angles = 2
#             elif operation in constant.three_param:
#                 num_angles = 3
#             else:
#                 num_angles = 0
