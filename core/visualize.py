...
def read_15layer(path, dirs):
    ...
    for dir in dirs:
        ...
        fidelities_ghz = pd.read_csv(
            path + dir + "/fidelities_ghz.csv", sep=",", header=None)
